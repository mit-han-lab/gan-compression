...
python train_supernet.py --dataroot database/coco_stuff --dataset_mode coco \
  ...
  --log_dir logs/gaugan/coco_lite/finetune \
  --restore_teacher_G_path pretrained/gaugan/coco_lite/full/latest_net_G.pth \
  --restore_student_G_path logs/gaugan/coco_lite/supernet/checkpoints/latest_net_G.pth \
  --restore_D_path logs/gaugan/coco_lite/supernet/checkpoints/latest_net_D.pth \
