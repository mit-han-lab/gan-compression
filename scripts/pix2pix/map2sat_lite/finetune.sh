...
python train_supernet.py --dataroot database/maps \
  --supernet resnet \
  --log_dir logs/pix2pix/map2sat_lite/finetune \
  ...
  --restore_student_G_path logs/pix2pix/map2sat_lite/supernet/checkpoints/latest_net_G.pth \
  --restore_D_path logs/pix2pix/map2sat_lite/supernet/checkpoints/latest_net_D.pth \
